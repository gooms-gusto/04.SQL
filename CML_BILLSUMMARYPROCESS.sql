...
BEGIN
  ...
  AND bs.billingSummaryId IN (IN_BillingSummaryID);
...
cur_billingsm_loop:
 ...
 SET OUT_returnCode = '*_*';
    ...
    INSERT INTO CML_TEMP_LOG (ID_STATUS)
      VALUES (CONCAT(r_generateArno));

UPDATE BIL_SUMMARY bs
SET bs.arNo=r_generateArno
WHERE bs.billingSummaryId=r_billingSummaryId and bs.warehouseId=r_warehouseId AND bs.customerId=r_customerId;
