SELECT DISTINCT
        ...
        (
                ...
                WHERE
                        customerType   = 'CA'
                        AND customerId = arh.carrierId LIMIT 1
        )                                                                    AS EXPEDITION_NAME,
        ...
        DATE_FORMAT(arh.startTime, '%Y-%m-%d %T')  AS START_LOADING,
        DATE_FORMAT(arh.endTime, '%Y-%m-%d %T')    AS END_LOADING  ,
