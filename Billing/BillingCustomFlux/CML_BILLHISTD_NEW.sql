...
DROP PROCEDURE IF EXISTS CML_BILLHISTD;
...
BEGIN
  ...
  SELECT
    ...
    IFNULL(CAST(SUM(atl.toQty_Each * bs.grossWeight) AS char(255)), 0) AS qtyChargeGrossWeight
...
cur_order_loop:
  LOOP
    ...
    od_qtyChargeNettWeight, od_qtyChargeGrossWeight;
