DROP PROCEDURE IF EXISTS CML_BILLSTORAGE_DAILY_PER_SKUGROUP;
...
BEGIN
  ...
  DECLARE OUT_returnCode varchar(1000);
    ...
    DECLARE my_cursor CURSOR FOR
        ...
        WHERE
            zib.organizationId =IN_organizationId
        ...
        GROUP BY zib.warehouseId, s.sku_group1, zib.StockDate,zib.customerId
