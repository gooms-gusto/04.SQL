...
DROP PROCEDURE IF EXISTS BILL_MOD339_REV1;

DELIMITER $$

CREATE
DEFINER = 'wms_ftest'@'%'
PROCEDURE BILL_MOD339_REV1(IN IN_organizationId varchar(30),
...
BEGIN
  ...
  ####################################################################
  DECLARE organizationId varchar(20);
DECLARE orderNo varchar(20);
DECLARE soReference1 varchar(255);
DECLARE soReference3 varchar(255);
DECLARE docType varchar(255);
DECLARE docTypeDescr varchar(255);
DECLARE soStatus varchar(255);
DECLARE warehouseId varchar(255);
DECLARE customerId varchar(255);
DECLARE orderLineNo varchar(255);
DECLARE SKU varchar(255);
DECLARE ShipmentTime varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
DECLARE qty varchar(255);
DECLARE qty_each varchar(255);
DECLARE qtyShipped_each varchar(255);
DECLARE uom varchar(255);
DECLARE qtyCharge varchar(255);
DECLARE totalCube varchar(255);
DECLARE editTime varchar(255);
DECLARE lotNum varchar(255);
DECLARE traceId varchar(255);
DECLARE pickToTraceId varchar(255);
DECLARE dropId varchar(255);
DECLARE location varchar(255);
DECLARE pickToLocation varchar(255);
DECLARE allocationDetailsId varchar(255);
DECLARE skuDescr1 varchar(255);
DECLARE grossWeight varchar(255);
DECLARE cubeNya varchar(255);
DECLARE tariffMasterId varchar(255);
DECLARE QtyPerCases varchar(255);
DECLARE QtyPerPallet varchar(255);
DECLARE zone varchar(255);
DECLARE batch varchar(255);
DECLARE lotAtt07 varchar(255);
DECLARE RecType varchar(21);
#####################################################
...
DECLARE od_ShipmentTime varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
od_organizationId,od_orderNo,od_soReference1,od_soReference3,od_docType,od_docTypeDescr,od_soStatus,od_warehouseId,
od_customerId,od_orderLineNo,od_SKU,od_ShipmentTime,od_qty,od_qty_each,od_qtyShipped_each,od_uom,od_qtyCharge,od_totalCube,
od_editTime,od_lotNum,od_traceId,od_pickToTraceId,od_dropId,od_location,od_pickToLocation,od_allocationDetailsId,od_skuDescr1,
od_grossWeight,od_cubeNya,od_tariffMasterId,od_QtyPerCases,od_QtyPerPallet,od_zone,od_batch,od_lotAtt07,od_RecType;
    ...
    LOOP
      ...
      SET R_billsummaryId = '';
	   ...
	   IF (R_ratebase='CUBIC') THEN
            SET R_RESULTQTYCHARGE=od_totalCube;
