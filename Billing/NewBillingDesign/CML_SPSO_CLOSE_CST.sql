...
DROP PROCEDURE IF EXISTS CML_SPSO_CLOSE_CST;

DELIMITER $$

CREATE
DEFINER = 'wms_ftest'@'%'
PROCEDURE CML_SPSO_CLOSE_CST (IN IN_organizationId varchar(20),
...
SELECT doh.customerId INTO l_customerId
        FROM DOC_ORDER_HEADER doh INNER JOIN
     ...
     IF (LENGTH( l_customerId> 0)) THEN
      ...
      VALUES('OJV_CML',IN_Warehouse,l_customerId,'SO',IN_SONO,'99','EDI',NOW(),'N');
