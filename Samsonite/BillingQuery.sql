...
..;                        )                                                   ELSE aad.uomdescrea END
        ...
        aad.rate                                                                         AS ChargeRate   ,
				case when aad.tariffMasterId='BIL00062' THEN (case when aad.lotAtt04='SET' then 0 else (aad.cubesku*aad.qty_each *  aad.rate ) end) 
				when aad.tariffMasterId='BIL00062PIECES' THEN (case when aad.lotAtt04='SET' then 0 else (aad.qty_each *  aad.rate ) end) ELSE 0 END as BillingAmmount,
        ' '                                                                        AS OVERTIME_CHARGE,
        ' '                                                                        AS STANDYBY_FEE   ,
