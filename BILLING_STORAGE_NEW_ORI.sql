  ...
  getTariff:
    LOOP
      ...
      BEGIN
        ...
        DROP TABLE IF EXISTS TMP_BIL_SUMMARY_INFO2;

        CREATE TEMPORARY TABLE TMP_BIL_SUMMARY_INFO2 (
          organizationId varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          asnReference1 varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          asnReference3 varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          ...
          asnNo varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          asnLineNo varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          sku varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          qtyReceived varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          uom varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          qtyReceivedEach varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          ...
          transactionTime varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
          ...
          muid varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          toLocation varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          transactionId varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          asnType varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          packId varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
          ...
          sku_group1 varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
        ...
        IF R_docType = 'CG' THEN
        BEGIN
          CALL debug_msg(@enabled, R_docType);
          INSERT INTO TMP_BIL_SUMMARY_INFO2
            SELECT
            ...
            AND atl.addTime >= '2023-09-05 00:00:00'
            AND atl.addTime <= '2023-09-08 00:00:00'
