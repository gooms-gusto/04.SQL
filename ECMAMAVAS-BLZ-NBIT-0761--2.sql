...
SELECT trf.organizationId,trf.warehouseId,trf.tdocNo,trf.qtyCSAll,btr.rate,trf.tariffMasterId,trf.tariffId,btr.classFrom,btr.classTo FROM
(SELECT trans.organizationId,
trans.warehouseId,
trans.customerId, 
trans.tdocNo,
trans.tdocType,SUM(trans.qtyCSAll) AS qtyCSAll, bil.tariffLineNo,bil.tariffMasterId,
bil.tariffId FROM
(SELECT dth.organizationId,dth.customerId, dth.warehouseId, dtd.tdocNo, CEIL(SUM(dtd.toQty / bp.qty )) AS qtyCSAll, dth.tdocType, bsm.tariffMasterId
...
trans.customerId, 
trans.tdocNo,
trans.tdocType, bil.tariffLineNo,bil.tariffMasterId,
bil.tariffId) trf
