...
PROCEDURE XYZ (IN IN_organizationId varchar(20),
...
BEGIN
  ...
  DECLARE vWaveNo varchar(20);
  DECLARE OUT_stageAlloc_Code varchar(20);
  DECLARE finished integer DEFAULT 0;

  -- declare vDocNo varchar(20);
  -- SELECT waveNo INTO IN_waveNo FROM DOC_ORDER_HEADER WHERE organizationId=IN_organizationId AND warehouseId=IN_warehouseId AND orderNo=IN_orderNo;
