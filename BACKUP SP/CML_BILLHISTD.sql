...
cur_order_loop:
  LOOP
    ...
    od_transactionTime, od_lotNum, od_traceId, od_muid, od_toLocation, od_transactionId,
    ...
    od_qtyChargeNettWeight, od_qtyChargeGrossWeight, od_qtyChargeMetricTon, od_closetimetransaction;/*additional nettweight grossweight metric ton*/
    ...
    END IF;
    SELECT
      CONCAT('** DEBUG:', od_asnNo, od_tariffMasterId) AS debug;
